    ...
    <span className="text-sm ">Back to home</span>
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between w-full px-4 lg:px-24">
          ...
          <div className="text-center lg:text-left lg:w-1/2 mb-8 lg:mb-0 lg:mr-20 hidden lg:block">
            <h1 className="text-4xl lg:text-5xl font-bold tracking-wide">Reconnect with Elegance</h1>
            <p className="text-2xl lg:text-3xl my-4">Log in to rediscover your favorite fragrances and new arrivals.</p>
          </div>

          {/* Right Side Sign-Up Form */}
          <div className="w-full lg:w-1/3 bg-white rounded-lg shadow-lg p-4 lg:p-6">
            <h2 className="text-2xl lg:text-3xl font-bold text-gray-800 mb-4 lg:mb-6">Welcome.</h2>
