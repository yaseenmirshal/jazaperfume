...
<div className="grid grid-cols-1 md:grid-cols-3 gap-12 w-full min-h-auto bg-[#FAF4E6] px-4 py-8 md:px-16 md:py-14">

{/* Fragrances Card */}
<div className="flex flex-col rounded-xl w-full bg-[#ffffff] text-gray-700 shadow-md transition-transform duration-500  mb-8 mt-10 md:mb-0 md:mt-0 md:hover:scale-105 hover:object-scale-down">
...
{/* Oils Card */}
<div className="flex flex-col rounded-xl w-full bg-[#ffffff] text-gray-700 shadow-md transition-transform duration-500 md:hover:scale-105 hover:object-scale-down mb-8 md:mb-0 md:mt-0">
...
{/* Gift / Kits Card */}
<div className="flex flex-col rounded-xl w-full bg-[#ffffff] text-gray-700 shadow-md transition-transform duration-500 md:hover:scale-105 hover:object-scale-down">
