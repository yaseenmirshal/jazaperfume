            ...
            <div className="mb-6">
              ...
              <div className="ml-6 mt-4 space-y-2">
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <label htmlFor="range1" className="cursor-pointer">
                    ₹ 0 - ₹ 500
                  </label>
                </div>
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    className="cursor-pointer"
                  />
                  <label htmlFor="range2" className="cursor-pointer">
                    ₹ 500 - ₹ 1,000
                  </label>
                </div>
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    className="cursor-pointer"
                  />
                  <label htmlFor="range3" className="cursor-pointer">
                    ₹ 1,000 - ₹ 2,000
                  </label>
                </div>
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    className="cursor-pointer"
                  />
                  <label htmlFor="range4" className="cursor-pointer">
                    ₹ 3,000 - ₹ 4,000
                  </label>
                </div>
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    className="cursor-pointer"
                  />
                  <label htmlFor="range5" className="cursor-pointer">
                    ₹ 4,000 - above
                  </label>
                </div>
              </div>
